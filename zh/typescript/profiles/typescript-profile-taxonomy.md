...
This file defines the 7 TypeScript CodeBTI profile families. Profiles can be combined when the user's answers are mixed, for example `Interface-First Boundary Keeper with Algorithm-First Minimalist traits`.
